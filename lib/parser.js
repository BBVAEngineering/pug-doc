...
function extractPugdocBlocks(filename, templateSrc){
  return templateSrc
    .split('\n')
    ...
    .map(function(line, lineIndex){
      ...
      var meta = parsePugdocComment(filename, comment);
...
function getPugdocDocuments(templateSrc, filename, locals){
  return extractPugdocBlocks(filename, templateSrc)
    .map(function(pugdocBlock) {
      var meta = parsePugdocComment(filename, pugdocBlock.comment);
...
function parsePugdocComment(filename, comment){
  ...
  try {
    ...
    console.log('------------------------------');
    console.log(e.name + ' in "' + filename + '"');
